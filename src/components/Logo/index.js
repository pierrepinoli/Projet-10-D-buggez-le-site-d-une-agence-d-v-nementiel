...
const Logo = ({ size }) => (
  <div className="Logo">
    ...
    >
      ...
      {/* La convention en React est d'utiliser le style camelCase, 
      où les noms de propriétés CSS sont en minuscules et séparés par des majuscules. */}
      <text fill="url(#paint5_linear_56_57)" 
            style={{fontFamily: 'Kalimati', fontSize: '39px', fontWeight: 700, whiteSpace: 'pre'}} 
